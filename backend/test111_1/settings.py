"""
Django settings for test111_1 project.
...
WSGI_APPLICATION = 'test111_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test111_1 API",
    "DESCRIPTION": "API documentation for test111_1 App",
    "VERSION": "v1",
}
